...
const otpSlotVariants = cva(
  'inline-flex items-center justify-center border [--_radius:var(--radius-input)] rounded-slot bg-background text-text-primary font-medium text-center outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      ...
      status: {
        default: 'border-border hover:border-slot-50 focus:border-slot focus:ring-2 focus:ring-slot-30',
        error: 'border-error focus:border-error focus:ring-2 focus:ring-error/30',
        warning: 'border-warning focus:border-warning focus:ring-2 focus:ring-warning/30',
        info: 'border-info focus:border-info focus:ring-2 focus:ring-info/30',
        success: 'border-success focus:border-success focus:ring-2 focus:ring-success/30',
      },
    },
